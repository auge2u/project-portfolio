    ...
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center mb-16">
          <h2 className="text-base text-blue-600 dark:text-blue-400 font-semibold tracking-wide uppercase">Contact</h2>
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
            Get In Touch
          </p>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-300 lg:mx-auto">
            Have questions about the projects or interested in collaboration? Send a message!
          </p>
        </div>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500 dark:text-gray-300">
                    ...
                    <p className="mt-1">For general inquiries and project discussions</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500 dark:text-gray-300">
                    <p>@auge2u</p>
                    <p className="mt-1">Follow the repositories and contribute to projects</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500 dark:text-gray-300">
                    ...
                    <p className="mt-1">Connect professionally for career opportunities</p>
                  </div>
                </div>
              </div>
            </div>
