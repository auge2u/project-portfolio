...
import { ProjectCategory, ProjectSegment, Project } from '../types';
import { sampleProjects, getProjectCollection } from '../data/sampleProjects';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {filteredProjects.length === 0 && (
            <div className="col-span-3 text-center py-12">
              ...
              <p className="mt-1 text-gray-500 dark:text-gray-400">Try adjusting your filters to find projects.</p>
            </div>
          )}
        </div>
      )}
