...
export const sampleProjects: Project[] = [
  {
    ...
    longDescription:
      "A comprehensive e-commerce solution built with modern technologies. Features include product catalog with advanced filtering, shopping cart management, secure payment processing, user accounts, and admin dashboard for inventory management.",
    repositoryUrl: "https://github.com/habitusnet/ecommerce-platform",
    imageUrl:
      "data:image/png;base64,",
    owner: "habitusnet",
  ...
  },
  {
    ...
    description:
      "A cross-platform mobile application for tracking health metrics and fitness activities",
    longDescription:
      "A user-friendly mobile app designed to help users track various health metrics, including steps, workouts, nutrition, and sleep patterns. The app provides insightful data visualizations and personalized recommendations.",
  ...
  },
  {
    ...
    description:
      "A machine learning platform for business analytics and predictive insights",
    longDescription:
      "An enterprise-grade analytics platform that leverages machine learning algorithms to provide predictive insights for business decision-making. The platform integrates with various data sources, processes large datasets, and generates actionable recommendations.",
    ...
    segments: [
      ProjectSegment.DATA_ENGINEERING,
      ProjectSegment.BACKEND,
      ProjectSegment.FRONTEND,
    ],
    technologies: [
      technologies.python,
  ...
  },
  {
    ...
    description:
      "A DevOps solution for automating cloud infrastructure deployment and management",
    longDescription:
      "A comprehensive DevOps toolset that enables teams to automate the provisioning, configuration, and management of cloud infrastructure. The solution provides infrastructure as code, continuous integration and deployment, and monitoring capabilities.",
  ...
  },
  {
    ...
    description:
      "A secure cryptocurrency trading platform built on blockchain technology",
    longDescription:
      "A secure and user-friendly platform for trading cryptocurrencies and digital assets. The platform leverages blockchain technology to ensure transparency, security, and immutability of transactions, while providing advanced trading features and analytics.",
